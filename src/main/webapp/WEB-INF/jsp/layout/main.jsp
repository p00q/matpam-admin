            ...
            <body>
                        ...
                        <%-- 현재 로그인 역할 (JSP EL용) --%>
                            ...
                            <%-- 운영관리: SUPER_ADMIN, OPERATOR만 표시 / CHANNEL_ADMIN 숨김 --%>
                                <c:if test="${loginRole ne 'CHANNEL_ADMIN'}">
                                    <div class="nav-group">
                                        <c:set var="isOpPage"
                                            value="${fn:startsWith(currentMenu, 'op_') or fn:contains(uriLower, 'operator') or fn:contains(uriLower, 'syschannel')}" />
                                        <div class="nav-parent ${isOpPage ? '' : 'collapsed'}" data-bs-toggle="collapse"
                                            data-bs-target="#menu_op" aria-expanded="${isOpPage ? 'true' : 'false'}">
                                            <div class="parent-icon"><i class="bi bi-shield-lock"></i></div>
                                            <span>운영관리</span>
                                            <i class="bi bi-chevron-down toggle-arrow"></i>
                                        </div>
                                        <div class="collapse ${isOpPage ? 'show' : ''}" id="menu_op"
                                            data-bs-parent=".sidebar-nav">
                                            <ul class="nav-child-list">
                                                <%-- 몰 기본정보: 전체 허용 (OPERATOR·SUPER_ADMIN) --%>
                                                    <li><a href="<c:url value='/admin/company/companyForm.do?companyId=1'/>"
                                                            class="nav-child-item ${currentMenu eq 'op_mall' ? 'active' : ''}">몰
                                                            기본정보</a></li>
                                                    <%-- 채널관리: OPERATOR 이상만 허용 --%>
                                                        <li><a href="<c:url value='/admin/sysChannel/channelList.do'/>"
                                                                class="nav-child-item ${currentMenu eq 'op_channel' ? 'active' : ''}">채널관리</a>
                                                        </li>
                                                        <%-- 운영자관리: SUPER_ADMIN만 허용 --%>
                                                            <c:if
                                                                test="${loginRole eq 'SUPER_ADMIN' or loginRole eq 'OPERATOR'}">
                                                                <li><a href="<c:url value='/admin/user/operatorList.do'/>"
                                                                        class="nav-child-item ${currentMenu eq 'op_operator' ? 'active' : ''}">운영자관리</a>
                                                                </li>
                                                            </c:if>
                                ...
                                <!-- 업체관리 -->
                                <div class="nav-group">
                                    <c:set var="isCompPage"
                                        value="${fn:startsWith(currentMenu, 'comp_') or fn:contains(uriLower, 'companylist')}" />
                                    <div class="nav-parent ${isCompPage ? '' : 'collapsed'}" data-bs-toggle="collapse"
                                        data-bs-target="#menu_comp" aria-expanded="${isCompPage ? 'true' : 'false'}">
                                        <div class="parent-icon"><i class="bi bi-building"></i></div>
                                        <span>업체관리</span>
                                        <i class="bi bi-chevron-down toggle-arrow"></i>
                                    </div>
                                    <div class="collapse ${isCompPage ? 'show' : ''}" id="menu_comp"
                                        data-bs-parent=".sidebar-nav">
                                        <ul class="nav-child-list">
                                            <li><a href="<c:url value='/admin/company/companyList.do?companyType=SELLER'/>"
                                                    class="nav-child-item ${currentMenu eq 'comp_seller' ? 'active' : ''}">판매업체</a>
                                            </li>
                                            <li><a href="<c:url value='/admin/company/companyList.do?companyType=BUYER'/>"
                                                    class="nav-child-item ${currentMenu eq 'comp_buyer' ? 'active' : ''}">구매업체</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="nav-group">
                                    <c:set var="isUserPage"
                                        value="${fn:startsWith(currentMenu, 'user_') or (fn:contains(uriLower, '/user/') and not fn:contains(uriLower, 'operator'))}" />
                                    <div class="nav-parent ${isUserPage ? '' : 'collapsed'}" data-bs-toggle="collapse"
                                        data-bs-target="#menu_user" aria-expanded="${isUserPage ? 'true' : 'false'}">
                                        <div class="parent-icon"><i class="bi bi-people"></i></div>
                                        <span>회원관리</span>
                                        <i class="bi bi-chevron-down toggle-arrow"></i>
                                    </div>
                                    <div class="collapse ${isUserPage ? 'show' : ''}" id="menu_user"
                                        data-bs-parent=".sidebar-nav">

                                        <ul class="nav-child-list">
                                            <li><a href="<c:url value='/admin/user/userList.do?userRole=SELLER_ADMIN'/>"
                                                    class="nav-child-item ${currentMenu eq 'user_seller' ? 'active' : ''}">판매회원</a>
                                            </li>
                                            <li><a href="<c:url value='/admin/user/userList.do?userRole=BUYER_ADMIN'/>"
                                                    class="nav-child-item ${currentMenu eq 'user_buyer' ? 'active' : ''}">구매회원</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <!-- 상품관리 -->
                                <div class="nav-group">
                                    <div class="nav-parent ${fn:startsWith(currentMenu, 'product') ? '' : 'collapsed'}"
                                        data-bs-toggle="collapse" data-bs-target="#menu_prod"
                                        aria-expanded="${fn:startsWith(currentMenu, 'product') ? 'true' : 'false'}">
                                        <div class="parent-icon"><i class="bi bi-box-seam"></i></div>
                                        <span>상품관리</span>
                                        <i class="bi bi-chevron-down toggle-arrow"></i>
                                    </div>
                                    <div class="collapse ${fn:startsWith(currentMenu, 'product') ? 'show' : ''}"
                                        id="menu_prod" data-bs-parent=".sidebar-nav">
                                        <ul class="nav-child-list">
                                            <li><a href="<c:url value='/admin/product/productList.do'/>"
                                                    class="nav-child-item ${currentMenu eq 'product' ? 'active' : ''}">상품목록</a>
                                            </li>
                                            <li><a href="<c:url value='/admin/product/productForm.do'/>"
                                                    class="nav-child-item">상품등록</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <!-- 주문관리 -->
                                <div class="nav-group">
                                    <div class="nav-parent ${fn:startsWith(currentMenu, 'order') ? '' : 'collapsed'}"
                                        data-bs-toggle="collapse" data-bs-target="#menu_order"
                                        aria-expanded="${fn:startsWith(currentMenu, 'order') ? 'true' : 'false'}">
                                        <div class="parent-icon"><i class="bi bi-cart3"></i></div>
                                        <span>주문관리</span>
                                        <i class="bi bi-chevron-down toggle-arrow"></i>
                                    </div>
                                    <div class="collapse ${fn:startsWith(currentMenu, 'order') ? 'show' : ''}"
                                        id="menu_order" data-bs-parent=".sidebar-nav">
                                        <ul class="nav-child-list">
                                            <li><a href="<c:url value='/admin/order/orderList.do'/>"
                                                    class="nav-child-item ${currentMenu eq 'order' ? 'active' : ''}">주문목록</a>
                                            </li>
                                ...
                                <!-- 정산관리 -->
                                <div class="nav-group">
                                    <div class="nav-parent ${fn:startsWith(currentMenu, 'settle') ? '' : 'collapsed'}"
                                        data-bs-toggle="collapse" data-bs-target="#menu_settle"
                                        aria-expanded="${fn:startsWith(currentMenu, 'settle') ? 'true' : 'false'}">
                                        <div class="parent-icon"><i class="bi bi-wallet2"></i></div>
                                        <span>정산관리</span>
                                        <i class="bi bi-chevron-down toggle-arrow"></i>
                                    </div>
                                    <div class="collapse ${fn:startsWith(currentMenu, 'settle') ? 'show' : ''}"
                                        id="menu_settle" data-bs-parent=".sidebar-nav">
                                        <ul class="nav-child-list">
                                            <li><a href="<c:url value='/admin/settlement/settlementList.do'/>"
                                                    class="nav-child-item ${currentMenu eq 'settlement' ? 'active' : ''}">판매정산</a>
                                            </li>
                ...
                <div class="top-bar">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <%-- 개발용 역할 전환 버튼 --%>
                            <div class="dropdown">
                                <button class="btn btn-sm btn-outline-warning dropdown-toggle py-1 px-3 shadow-sm"
                                    type="button" id="roleDropdown" data-bs-toggle="dropdown" aria-expanded="false"
                                    style="border-radius:20px; font-weight:600; font-size:0.75rem; border-color: rgba(245, 158, 11, 0.3);">
                                    <i class="bi bi-person-badge me-1"></i> 권한 변경 (테스트)
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0"
                                    aria-labelledby="roleDropdown">
                                    <li>
                                        <h6 class="dropdown-header">관리자 계정</h6>
                                    </li>
                                    <li><a class="dropdown-item small"
                                            href="<c:url value='/admin/login.do?role=SUPER'/>"><i
                                                class="bi bi-shield-lock me-2 text-warning"></i>수퍼관리자 (admin)</a></li>
                                    <li><a class="dropdown-item small"
                                            href="<c:url value='/admin/login.do?role=OP'/>"><i
                                                class="bi bi-gear me-2 text-primary"></i>몰운영자 (operator01)</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li>
                                        <h6 class="dropdown-header">채널관리자 계정</h6>
                                    </li>
                                    <li><a class="dropdown-item small"
                                            href="<c:url value='/admin/login.do?role=CH3'/>"><i
                                                class="bi bi-truck me-2 text-success"></i>전국택배 (new_op_arch_01)</a></li>
                                    <li><a class="dropdown-item small"
                                            href="<c:url value='/admin/login.do?role=CH4'/>"><i
                                                class="bi bi-box-seam me-2 text-info"></i>화물직송 (optest99)</a></li>
                                    <li><a class="dropdown-item small"
                                            href="<c:url value='/admin/login.do?role=CH5'/>"><i
                                                class="bi bi-shop me-2 text-secondary"></i>공장수령 (sync_test_002)</a></li>
                                </ul>
                            </div>
                            <div class="badge px-3 py-2 border shadow-sm"
                                style="background: rgba(255,255,255,0.05); color: var(--accent); border-color: var(--glass-border) !important;">
                ...
                <!-- ── [공통] 통합 관리 팝업 ── -->
                <div class="modal fade" id="adminCommonModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content border-0 shadow-lg"
                            ...
                            <div class="modal-header modal-premium-header border-0">
                                <h5 class="modal-title fw-bold text-white" id="adminCommonModalTitle"
                            ...
                            <div class="modal-body p-0" id="adminCommonModalBody"
