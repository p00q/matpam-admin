    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                        ...
                        <div class="container-fluid px-0">
                            ...
                            <div class="px-4 pt-3 pb-1">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <h4 class="fw-bold mb-0" style="color:#1e293b;"><i
                                            class="bi bi-people-fill me-2"></i>${pageTitle}</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0" style="font-size:.78rem;">
                                            <li class="breadcrumb-item"><a
                                                    href="<c:url value='/admin/dashboard/main.do'/>"
                                                    class="text-decoration-none text-muted">대시보드</a></li>
        ...
        ══════════════════════════════════════════ -->
                                <div class="kpi-grid" id="kpiGrid">
                                    <div class="kpi-card">
                                        <div class="kpi-icon total"><i class="bi bi-people-fill"
                                                style="color:#4361ee;"></i></div>
                                        <div class="kpi-body">
                                    ...
                                    <div class="kpi-card">
                                        <div class="kpi-icon active"><i class="bi bi-check-circle-fill"
                                    ...
                                    <div class="kpi-card">
                                        <div class="kpi-icon locked"><i class="bi bi-lock-fill"
        ...
        ══════════════════════════════════════════ -->
                                <div class="search-panel">
                                    ...
                                    <form:form modelAttribute="searchVO" id="searchForm" name="searchForm" method="get"
                                        action="${pageContext.request.contextPath}/admin/user/userList.do">
                                        ...
                                        <div class="row g-3 align-items-end">
                                            ...
                                            <div class="col-xl-2 col-md-4 col-sm-6">
                                                <label class="form-label fw-semibold"
                                                    style="font-size:.8rem;">테넌트</label>
                                            ...
                                            <div class="col-xl-4 col-md-8 col-sm-9">
                                                <label class="form-label fw-semibold" style="font-size:.8rem;">검색어 (ID /
                                                    이름)</label>
                                            ...
                                            <div class="col-xl-2 col-md-4 col-sm-3">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="<c:url value='/admin/user/userList.do'/>"
                                                        class="btn btn-outline-secondary btn-sm" title="초기화">
                                ...
                                <div class="list-card">
                                    ...
                                    <div class="list-card-header">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <select class="form-select form-select-sm" style="width:auto;"
                                                ...
                                                <option value="10" ${searchVO.pageUnit==10 || searchVO.pageUnit==null
                                                    ? 'selected' : '' }>10건</option>
                                                <option value="20" ${searchVO.pageUnit==20 ? 'selected' : '' }>20건
                                                </option>
                                                <option value="50" ${searchVO.pageUnit==50 ? 'selected' : '' }>50건
                                                </option>
                                                <option value="100" ${searchVO.pageUnit==100 ? 'selected' : '' }>100건
                                                </option>
                                            </select>
                                                ...
                                                <c:choose>
                                                    <c:when test="${not empty userList}">
                                                        <c:forEach var="item" items="${userList}" varStatus="st">
                                                            <c:if
                                                                test="${item.userRole != 'CHANNEL_ADMIN' and item.userRole != 'OPERATOR'}">
                                                                <tr id="row-${item.userId}">

                                                                    <!-- No -->
                                                                    <td class="text-center"
                                                                        style="color:#94a3b8; font-size:.75rem;">
                                                                        ${paginationInfo.totalRecordCount -
                                                                        paginationInfo.firstRecordIndex - st.index}
                                                                    </td>
                                                                    ...
                                                                    <td style="font-size:.82rem; color:#64748b;">
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${not empty item.channelName}">
                                                                                ${item.channelName}</c:when>
                                                                            <c:otherwise><span
                                                                    ...
                                                                    <td>
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${item.userRole == 'SUPER_ADMIN'}">
                                                                                <span
                                                                                    style="font-size:.75rem; color:#94a3b8; font-style:italic;">전체
                                                                                    플랫폼</span>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${not empty item.companyName}">
                                                                                        ${item.companyName}</c:when>
                                                                                    <c:otherwise><span
                                                                    ...
                                                                    <!-- 상태 -->
                                                                    <td class="text-center"
                                                                        id="status-cell-${item.userId}">
                                                                        <span
                                                                            class="status-badge status-${item.status}">
                                                                            <span
                                                                                class="status-dot dot-${item.status}"></span>
                                                                            <c:choose>
                                                                                <c:when
                                                                                    test="${item.status == 'ACTIVE'}">활성
                                                                                </c:when>
                                                                                <c:when
                                                                                    test="${item.status == 'LOCKED'}">잠금
                                                                                </c:when>
                                                                    ...
                                                                    <td class="text-center"
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when
                                                                                test="${not empty item.lastLoginAt}">
                                                                                <fmt:formatDate
                                                                                    value="${item.lastLoginAt}"
                                                                                    pattern="yyyy-MM-dd" />
                                                                            </c:when>
                                                                            <c:otherwise><span
                                                                                    style="color:#cbd5e1;">미로그인</span>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                    </td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="action-btn-group">
                                                                            ...
                                                                            <!-- 수정 -->
                                                                            <a href="javascript:;"
                                                                                onclick="fn_openUserModal(${item.userId})"
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end shadow-sm status-dropdown"
                                                                                    ...
                                                                                    <li>
                                                                                        <h6 class="dropdown-header"
                                                                                            style="font-size:.7rem;">상태
                                                                                            변경</h6>
                                                                                    </li>
                                                                                    <c:if
                                                                                        test="${item.status != 'ACTIVE'}">
                                                                                        <li>
                                                                                            <a class="dropdown-item"
                                                                                                href="javascript:;"
                                                                                                onclick="fn_changeStatus(${item.userId},'ACTIVE')">
                                                                                                <span
                                                                                                    class="status-dot dot-ACTIVE"
                                                                                    ...
                                                                                    <c:if
                                                                                        test="${item.status != 'LOCKED'}">
                                                                                        <li>
                                                                                            <a class="dropdown-item"
                                                                                                href="javascript:;"
                                                                                                onclick="fn_changeStatus(${item.userId},'LOCKED')">
                                                                                                <span
                                                                                                    class="status-dot dot-LOCKED"
                                                                                                    style="display:inline-block;"></span>
                                                                                                잠금으로 변경
                                                                                            </a>
                                                                                        </li>
                                                                                    ...
                                                                                    <c:if
                                                                                        test="${item.status != 'INACTIVE'}">
                                                                                        <li>
                                                                                            <a class="dropdown-item"
                                                                                                href="javascript:;"
                                                                                                onclick="fn_changeStatus(${item.userId},'INACTIVE')">
                                                                                                <span
                                                                                                    class="status-dot dot-INACTIVE"
                                                                                                    style="display:inline-block;"></span>
                                                                                                비활성으로 변경
                                                                                            </a>
                                                                                        </li>
                                                        ...
                                                        <tr>
                                                            <td colspan="9">
                                                                <div class="empty-state">
                                                                    ...
                                                                    <div class="empty-text fw-semibold"
                                                                        style="color:#475569;">
                                                                        검색 결과가 없습니다.
                                                                    </div>
                                                                    <div class="mt-2"
                                    ...
                                    <div class="pagination-wrap">
                                        <div class="pagination-info">
                                            ...
                                            <c:choose>
                                                <c:when
                                                    test="${paginationInfo.firstRecordIndex + paginationInfo.recordCountPerPage > paginationInfo.totalRecordCount}">
                                                    <strong>${paginationInfo.totalRecordCount}</strong>
                                                </c:when>
                                                <c:otherwise>
                                                    <strong>${paginationInfo.firstRecordIndex +
                                                        paginationInfo.recordCountPerPage}</strong>
                                                </c:otherwise>
                                            </c:choose>
                                            건 표시
                                        </div>
                                        <nav>
                                            <ul class="pagination mb-0">
                                                ...
                                                <c:if test="${paginationInfo.currentPageNo > 1}">
                                                    <li class="page-item">
                                                        <a class="page-link" href="javascript:fn_egov_link_page(1);"
                                                            title="처음">
                                                ...
                                                <c:forEach var="i" begin="${paginationInfo.firstPageNoOnPageList}"
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="javascript:fn_egov_link_page(${i});">${i}</a>
                                                            </li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                                ...
                                                <c:if
                                                    ...
                                                    <li class="page-item">
                                                        <a class="page-link"
                                                            href="javascript:fn_egov_link_page(${paginationInfo.totalPageCount});"
                                                            title="마지막">
