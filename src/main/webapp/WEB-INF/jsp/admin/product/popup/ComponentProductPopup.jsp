                    ...
                    <body>
                                                    ...
                                                    <select name="saleTypeCd" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="code" items="${saleTypes}">
                                                            <option value="${code.detailCode}" <c:if
                                                                test="${searchVO.saleTypeCd eq code.detailCode}">
                                                                selected</c:if>>
                                                                ${code.detailCodeName}
                                                            </option>
                                                        </c:forEach>
                                                ...
                                                <td>
                                                    <select name="sellerMemberId" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="seller" items="${sellers}">
                                                            ...
                                                            <c:set var="legacySellerId"
                                                                value="${fn:trim(seller.memberId)}" />
                                                            <option value="${sellerPk}" <c:if
                                                                test="${searchVO.sellerMemberId eq sellerPk or searchVO.sellerMemberId eq legacySellerId}">
                                                                selected</c:if>>
                                                                ${seller.companyName}
                                                            </option>
                                                        </c:forEach>
                                                ...
                                                <td>
                                                    <select name="storageTypeCd" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="code" items="${storageTypes}">
                                                            <option value="${code.detailCode}" <c:if
                                                                test="${searchVO.storageTypeCd eq code.detailCode}">
                                                                selected</c:if>>
                                                                ${code.detailCodeName}
                                                            </option>
                                                        </c:forEach>
                                                ...
                                                <td>
                                                    <select name="saleStatusCd" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="code" items="${saleStatuses}">
                                                            <option value="${code.detailCode}" <c:if
                                                                test="${searchVO.saleStatusCd eq code.detailCode}">
                                                                selected</c:if>>
                                                                ${code.detailCodeName}
                                                            </option>
                                                        </c:forEach>
                                                ...
                                                <td>
                                                    <select name="processTypeCd" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="code" items="${processTypes}">
                                                            <option value="${code.detailCode}" <c:if
                                                                test="${searchVO.processTypeCd eq code.detailCode}">
                                                                selected</c:if>>
                                                                ${code.detailCodeName}
                                                            </option>
                                                        </c:forEach>
                                                ...
                                                <td>
                                                    <select name="unitTypeCd" class="form-select form-select-sm">
                                                        ...
                                                        <c:forEach var="code" items="${unitTypes}">
                                                            <option value="${code.detailCode}" <c:if
                                                                test="${searchVO.unitTypeCd eq code.detailCode}">
                                                                selected</c:if>>
                                                                ${code.detailCodeName}
                                                            </option>
                                                        </c:forEach>
                                    ...
                                    <table class="table table-bordered table-hover text-center align-middle mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <c:if test="${empty componentList}">
                                                <tr>
                                                    <td colspan="12" class="py-4 text-center text-muted">검색된 결과가 없습니다.
                                                    </td>
                                                </tr>
                                            </c:if>
                                        </tbody>
                        ...
                        <script>
                            ...
                            <c:forEach var="item" items="${componentList}">
                                <fmt:formatNumber var="popListPriceInt" value="${item.listPrice}" maxFractionDigits="0" groupingUsed="false" />
                                <fmt:formatNumber var="popCostPriceInt" value="${item.costPrice}" maxFractionDigits="0" groupingUsed="false" />
                                <fmt:formatNumber var="popVatAmountInt" value="${item.vatAmount}" maxFractionDigits="0" groupingUsed="false" />
                                ...
                                listPrice: <c:out value="${popListPriceInt}" default="0" />,
                                costPrice: <c:out value="${popCostPriceInt}" default="0" />,
                                vatAmount: <c:out value="${popVatAmountInt}" default="0" />,
