                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="saleDivCd" class="form-select form-select-sm"
                                        ...
                                        <option value="" disabled <c:if test="${empty bundle.saleDivCd}">selected</c:if>
                                            >선택</option>
                                        <c:forEach var="code" items="${saleTypeList}">
                                            <option value="${code.detailCode}" <c:if
                                                test="${bundle.saleDivCd eq code.detailCode}">selected</c:if>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="storageTypeCd" class="form-select form-select-sm"
                                        style="max-width: 200px;" required>
                                        <option value="" disabled <c:if test="${empty bundle.storageTypeCd}">selected
                                            </c:if>>선택</option>
                                        <c:forEach var="code" items="${storageTypeList}">
                                            <option value="${code.detailCode}" <c:if
                                                test="${bundle.storageTypeCd eq code.detailCode}">selected</c:if>
                                                >${code.detailCodeName}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                                ...
                                <td>
                                    <select name="saleMemberNo" class="form-select form-select-sm"
                                        style="max-width: 200px;" required>
                                        <option value="" disabled <c:if test="${empty bundle.saleMemberNo}">selected
                                            </c:if>>선택</option>
                                        <c:forEach var="seller" items="${sellers}">
                                            <option value="${seller.memberNo}" <c:if
                                                test="${bundle.saleMemberNo eq seller.memberNo}">selected</c:if>
                                                >${seller.companyName} (${seller.ceoName})</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="processDivCd" class="form-select form-select-sm"
                                        style="max-width: 200px;" required>
                                        <option value="" disabled <c:if test="${empty bundle.processDivCd}">selected
                                            </c:if>>선택</option>
                                        <c:forEach var="code" items="${processTypeList}">
                                            <option value="${code.detailCode}" <c:if
                                                test="${bundle.processDivCd eq code.detailCode}">selected</c:if>
                                                >${code.detailCodeName}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="cutTypeCd" class="form-select form-select-sm"
                                        style="max-width: 200px;" required>
                                        <option value="" disabled <c:if test="${empty bundle.cutTypeCd}">selected</c:if>
                                            >선택</option>
                                        <c:forEach var="code" items="${cutTypes}">
                                            <option value="${code.detailCode}" <c:if
                                                test="${bundle.cutTypeCd eq code.detailCode}">selected</c:if>
                                                >${code.detailCodeName}</option>
                                        </c:forEach>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="exposureStatusCd" class="form-select form-select-sm"
                                        ...
                                        <option value="Y" <c:if test="${bundle.exposureStatusCd eq 'Y'}">selected</c:if>
                                            >노출</option>
                                        <option value="N" <c:if test="${bundle.exposureStatusCd eq 'N'}">selected</c:if>
                                            >미노출</option>
                                    </select>
                                </td>
                            </tr>
