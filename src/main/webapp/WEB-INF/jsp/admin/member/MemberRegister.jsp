        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <div class="container-fluid p-4">
                    ...
                    <nav aria-label="breadcrumb" class="mb-3">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<c:url value='/admin/member/memberList.do?menu=member'/>">회원관리</a>
                            </li>
                    ...
                    <!-- managers : 수정/상세 시 member.memberManagers, 신규 시 controllers에서 넘겨준 managers -->
                    <c:set var="managers"
                    ...
                    <form name="memberForm" method="post" action="<c:url value='/admin/member/insertMember.do'/>">
                        ...
                        <ul class="nav nav-tabs mb-3" id="memberTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="basic-tab" data-bs-toggle="tab"
                                    data-bs-target="#basic" type="button" role="tab">기본정보</button>
                            </li>
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="delivery-tab" data-bs-toggle="tab"
                                    data-bs-target="#delivery" type="button" role="tab">배송지</button>
                            </li>
                        </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="memberType" id="memberType"
                                                    ...
                                                    required>
                                                    <option value="" disabled <c:if test="${empty member.memberType}">
                                                        selected</c:if>>
                                                        회원타입 선택
                                                    </option>
                                                    <c:forEach var="type" items="${memberTypes}">
                                                        <option value="${type.detailCode}" <c:if
                                                            test="${member.memberType eq type.detailCode}">
                                                            selected="selected"
                                                            </c:if>>
                                                            ${type.detailCodeName}
                                                        </option>
                                                ...
                                                <select name="memberGrade" class="form-select form-select-sm"
                                                    ...
                                                    <c:forEach var="grade" items="${memberGrades}">
                                                        <option value="${grade.detailCode}" <c:if
                                                            test="${member.memberGrade eq grade.detailCode}">
                                                            selected="selected"
                                                            </c:if>>
                                            ...
                                            <td>
                                                <select name="status" class="form-select form-select-sm"
                                                    ...
                                                    <c:forEach var="statusItem" items="${statusCodes}">
                                                        <option value="${statusItem.detailCode}" <c:if
                                                            test="${member.status eq statusItem.detailCode}">
                                                            selected="selected"
                                                            </c:if>>
                                                            ${statusItem.detailCodeName}
                                                        </option>
                                                    </c:forEach>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="companyPhone"
                                                    class="form-control form-control-sm" placeholder="02-0000-0000"
                                                    maxlength="13" value="<c:out value='${member.companyPhone}'/>" />
                                            </td>
                                            <th>이메일주소</th>
                                            <td>
                                            ...
                                            <td colspan="3">
                                                <div class="d-flex gap-2 mb-2">
                                                    <input type="text" id="postcode" name="postcode"
                                                        ...
                                                        value="<c:out value='${member.postcode}'/>" />
                                                ...
                                                <input type="text" name="addressDetail"
                                                    class="form-control form-control-sm" placeholder="상세주소"
                                                    value="<c:out value='${member.addressDetail}'/>" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

                                <!-- 관리자 타입이 아닌 경우에만 담당자 영역 노출 -->
                                <c:if test="${empty member.memberType or member.memberType ne 'ADMIN'}">
                                    <div id="managerBlock">
                                        <div class="section-header">
                                            ■ 담당자 정보
                                            <button type="button" id="btnAddManager"
                                                            ...
                                                            <div class="manager-section" data-index="${status.index}">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <strong class="manager-title">
                                                                            담당자 ${status.index + 1}
                                                                        </strong>
                                                                        <div class="form-check mb-0">
                                                                            <input class="form-check-input main-radio"
                                                                                type="radio" name="mainManagerIndex"
                                                                                value="${status.index}" <c:if
                                                                                test="${manager.mainYn eq 'Y' or (empty manager.mainYn and status.first)}">
                                                                            checked="checked"
                                </c:if> />
                        ...
                        <button type="button"
                            class="btn btn-sm btn-danger remove-manager-btn
                                                        <c:if test='${status.first and fn:length(managers) == 1}'>d-none</c:if>"
                            onclick="removeManager(this)">삭제</button>
                </div>

                <input type="hidden" class="main-yn-field" name="memberManagers[${status.index}].mainYn"
                    value="<c:out value='${empty manager.mainYn ? (status.first ? " Y" : "N" ) : manager.mainYn}' />" />
                <input type="hidden" class="use-yn-field" name="memberManagers[${status.index}].useYn"
                ...
                <table class="table table-bordered form-table mb-0">
                    <tbody>
                        <tr>
                            <th>이름</th>
                            <td>
                                <input type="text" id="managerName${status.index}" data-field="managerName"
                            ...
                            <th>전화번호</th>
                            <td>
                                <input type="tel" id="managerPhone${status.index}" data-field="phoneNumber"
                                    name="memberManagers[${status.index}].phoneNumber"
                                    class="form-control form-control-sm" placeholder="010-0000-0000" maxlength="13"
                        ...
                        <tr>
                            <th>휴대전화번호</th>
                            <td>
                                <input type="tel" id="managerMobile${status.index}" data-field="mobileNumber"
                            ...
                            <th>이메일주소</th>
                            <td>
                                <input type="email" id="managerEmail${status.index}" data-field="email"
                                    name="memberManagers[${status.index}].email" class="form-control form-control-sm"
                    ...
                    <div class="manager-section" data-index="0">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="form-check mb-0">
                                    <input class="form-check-input main-radio" type="radio" name="mainManagerIndex"
                        ...
                        <input type="hidden" class="main-yn-field" name="memberManagers[0].mainYn" value="Y" />
                        <input type="hidden" class="use-yn-field" name="memberManagers[0].useYn" value="Y" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="tel" id="managerPhone0" data-field="phoneNumber"
                                            name="memberManagers[0].phoneNumber" class="form-control form-control-sm"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="tel" id="managerMobile0" data-field="mobileNumber"
                                            name="memberManagers[0].mobileNumber" class="form-control form-control-sm"
                                            placeholder="010-0000-0000" maxlength="13"
                ...
                <div class="p-3">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="agreeMarketing" id="agreeMarketing"
                            value="Y" <c:if test="${member.agreeMarketing eq 'Y'}">
                        checked="checked"
                        </c:if> />
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="agreeSms" id="agreeSms" value="Y" <c:if
                            test="${member.agreeSms eq 'Y'}">
                        checked="checked"
                        </c:if> />
                        <label class="form-check-label" for="agreeSms">
                            문자 수신 여부
                        </label>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered form-table">
                        <tbody>
                            <tr>
                                <th>거래일자</th>
                                <td>
                                    <input type="date" name="transactionDate" class="form-control form-control-sm"
                                        style="max-width: 200px;" />
                                </td>
                                <th>수정일자</th>
                                <td>
                                    <input type="date" name="transactionModifyDate" class="form-control form-control-sm"
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        attachPhoneFormatter(
                            document.querySelectorAll(
                                'input[type="tel"], input[name="businessNumber"], input[name="contactNumber"], input[name="companyPhone"]'
                            )
                        );
                        document.querySelectorAll('.main-radio').forEach(radio =>
                            radio.addEventListener('change', syncMainFlags)
                        );
                        syncMainFlags();
                        toggleManagerArea();
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="form-check mb-0">
                        <input class="form-check-input main-radio" type="radio"
                               name="mainManagerIndex" value="${index}">
                        <label class="form-check-label">기본 담당자</label>
                    </div>
                </div>
                <button type="button"
            ...
            <input type="hidden" class="main-yn-field"
                   name="memberManagers[${index}].mainYn" value="N" />
            <input type="hidden" class="use-yn-field"
                   name="memberManagers[${index}].useYn" value="Y" />
            <table class="table table-bordered form-table mb-0">
                <tbody>
                <tr>
                    <th>이름</th>
                    <td>
                        <input type="text" data-field="managerName"
                               name="memberManagers[${index}].managerName"
                               class="form-control form-control-sm" />
                    </td>
                    <th>전화번호</th>
                    <td>
                        <input type="tel" data-field="phoneNumber"
                               name="memberManagers[${index}].phoneNumber"
                               class="form-control form-control-sm"
                               placeholder="010-0000-0000" maxlength="13" />
                    </td>
                </tr>
                <tr>
                    <th>휴대전화번호</th>
                    <td>
                        <input type="tel" data-field="mobileNumber"
                               name="memberManagers[${index}].mobileNumber"
                               class="form-control form-control-sm"
                               placeholder="010-0000-0000" maxlength="13" />
                    </td>
                    <th>이메일주소</th>
                    <td>
                        <input type="email" data-field="email"
                               name="memberManagers[${index}].email"
                               class="form-control form-control-sm" />
                    </td>
                </tr>
                </tbody>
                ...
                <c:if test="${mode eq 'update'}">
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            if (breadcrumbActive) breadcrumbActive.textContent = '회원정보 상세';

                            // Form Action Change
                            const form = document.querySelector('form[name="memberForm"]');
                            form.action = "<c:url value='/admin/member/updateMember.do'/>";

                            // Show Buttons
                            const btnSave = document.getElementById('btnSave');
                            if (btnSave) btnSave.textContent = '수정';

                            // ID is Readonly in Update Mode
