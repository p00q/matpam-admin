...
public class AdvanceLedgerVO implements Serializable {
    private static final long serialVersionUID = 1L;

    private Long advanceLedgerId;
    private Long tenantId;
    private Long sellerCompanyId;
    private Long buyerCompanyId;
    private String txnType; // DEPOSIT, WITHDRAW, ORDER_PAY, ORDER_CANCEL, ADJUST
    ...
    // Getters and Setters
    public Long getAdvanceLedgerId() { return advanceLedgerId; }
    public void setAdvanceLedgerId(Long advanceLedgerId) { this.advanceLedgerId = advanceLedgerId; }
