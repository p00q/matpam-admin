...
path = r'd:\antigravity\matpam-admin\src\main\java\kr\co\matpam\admin\financial\service\impl\B2bFinancialServiceImpl.java'
with open(path, 'rb') as f:
    content = f.read()

# Replace corrupted sequences
# Note: These are rough guesses based on the output.
# Actually, I'll just rewrite the file with clean content.

new_content = """package kr.co.matpam.admin.financial.service.impl;
